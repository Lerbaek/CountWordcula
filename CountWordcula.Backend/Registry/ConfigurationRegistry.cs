...
public static class ConfigurationRegistry
{
  ...
  public static readonly string OutputExcludedFileName = OutputFileName("EXCLUDED");
  public static readonly string OutputIncludedFileName = OutputFileName("WORD_COUNT");
